...
// moving thread t2 to the state timed waiting
            ...
            System.out.println("The state of thread t1 while it invoked the method join() on thread t2 -"+ SampleThread.t1.getState());
...
// try-catch block
    ...
    public class SampleThread implements Runnable
    {
        ...
        public static SampleThread obj;

        // main method
        public static void main(String argvs[])
        {
// creating an object of the class ThreadState
            obj = new SampleThread();
            t1 = new Thread(obj);
